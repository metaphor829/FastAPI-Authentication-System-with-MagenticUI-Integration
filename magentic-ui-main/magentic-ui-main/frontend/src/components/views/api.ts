...
export class SessionAPI {
      ...
      return [
        {
          ...
          description: "Welcome to Magentic-UI! This is a demo session.",
        }
      ];
    }
  }
  ...
  async getSessionRuns(
    ...
    try {
      ...
      console.log("API not available, using mock data for session runs");
      // 返回模拟数据
      return {
        runs: [
          {
            ...
            task: {
              source: "user",
              content: "Welcome to Magentic-UI!",
              metadata: {}
            },
            team_result: null,
            messages: [
              {
                ...
                config: {
                  source: "assistant",
                  content: "Welcome to Magentic-UI! This is a demo environment.",
                  metadata: {}
                }
              }
            ]
